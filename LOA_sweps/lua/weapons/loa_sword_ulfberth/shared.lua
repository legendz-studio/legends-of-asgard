SWEP.Base = "dangumeleebase_fixed"

SWEP.AdminSpawnable = true

SWEP.AutoSwitchTo = false
SWEP.Slot = 0
SWEP.PrintName = "Ulfberth"
SWEP.Author = "Olibar + rexunlovable"
SWEP.Spawnable = true
SWEP.AutoSwitchFrom = false
SWEP.Weight = 5
SWEP.Category = "LOA - Épées"
SWEP.SlotPos = 1
 
SWEP.Purpose = "a Longsword a long way from home!"
...
SWEP.Rarity=2 -- Commun,Atypique,Rare,Épique,Légendaire,Mythique

--SWEPs are dumb (or I am) so we must state the weapon name again
SWEP.WepName="loa_sword_ulfberth"
...
SWEP.Charge = 0
SWEP.ChargeSpeed = 0.8
SWEP.DmgMin = 10
SWEP.DmgMax = 45
SWEP.Delay = 0.6
SWEP.TimeToHit = 0.05
SWEP.AttackAnimRate = 1.0
SWEP.Range = 55
...
SWEP.DmgMin2 = 10
SWEP.DmgMax2 = 45
SWEP.ThrowModel = "models/long/long1.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/long/long1.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(92.337, 94.675, 4.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana"] = { type = "Model", model = "models/long/long1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, 0), angle = Angle(-85.325, -8.183, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}